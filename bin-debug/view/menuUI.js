var menuUI = (function (_super) {
    ...
    function menuUI() {
        _super.call(this);
        this._writeR = [this._writeR1, this._writeR2, this._writeR3, this._writeR4, this._writeR5];
        this._writeX = [59, 197.22, 334.79, 473.01, 611.23];
        this.weizhi = [0, -750, -1500, -2250, -3000];
