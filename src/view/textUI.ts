...
class textUI extends egret.DisplayObjectContainer{
    constructor() {
        super();
    ...
    private bg:egret.Bitmap;                            //页面背景
    private _tableBg:egret.Bitmap;                      //表单背景
    private _tableBg_1:egret.Bitmap;                    //表单
    private _tableBtn:egret.Bitmap;                     //表单提交按钮
    private _tableGroup:egret.DisplayObjectContainer;   //表单容器
    private _tableName:egret.TextField;                 //姓名输入框
    private _tablePhone:egret.TextField;                //电话输入框
    private _tablePoint:egret.TextField;                //错误提示
    /**
     * @returns void
     * 填写表单
     */
