...
<script language="javascript">
    ...
    app.wechat = function(){};
    app.wechat.sharecontent = {title: "WMF秋运把厨房健康神器带回家",
                                 desc:"朋友，我的秋运团聚餐桌为你留了一个好位置，不点进来吗？",
                                 titleformoment:"【聚美味聚健康聚幸福】只需两步，把价值6888元WMF奈彩米新品带回家！", 
                                 url: app.sharUrl,
                                 icon: "http://www.createcdigital.com/wmfh520160830/share-icon.jpg"
                            };
    app.wechat.set_sharecontent = function(){
        wx.ready(function () {
            ...
            wx.onMenuShareTimeline({
                ...
                success: function () {
                    // 用户确认分享后执行的回调函数
                    var sharefor = new wmf.shareFor();
                    sharefor.callEgretMethod("type=share-Moments");
                },
                cancel: function () {
                    // 用户取消分享后执行的回调函数
            ...
            wx.onMenuShareAppMessage({
                ...
                success: function () {
                    // 用户确认分享后执行的回调函数
                    var sharefor = new wmf.shareFor();
                    sharefor.callEgretMethod("type=share-Chat");
                },
                cancel: function () {
                    // 用户取消分享后执行的回调函数
            ...
            wx.onMenuShareQQ({
                ...
                success: function () {
                    // 用户确认分享后执行的回调函数
                    var sharefor = new wmf.shareFor();
                    sharefor.callEgretMethod("type=share-QQ");
                },
                cancel: function () {
                    // 用户取消分享后执行的回调函数
                }
            ...
            wx.onMenuShareWeibo({
                ...
                success: function () {
                    // 用户确认分享后执行的回调函数
                    var sharefor = new wmf.shareFor();
                    sharefor.callEgretMethod("type=share-Weibo");
                },
                cancel: function () {
                    // 用户取消分享后执行的回调函数
                }
